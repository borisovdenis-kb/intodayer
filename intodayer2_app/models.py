...
class DayOfWeeks(models.Model):
    ...
    _def = models.CharField(max_length=50, blank=True, null=True)
...
class Schedules(models.Model):
    ...
    def __str__(self):
        schd_def = (self.grp_grp_id.fclt_fclt_id.unvr_unvr_id,
                    self.grp_grp_id.fclt_fclt_id,
                    self.grp_grp_id,
                    self.cthd_cthd_id,
                    self.dfwk_dfwk_id,
                    self.subj_subj_id,
        ...
        return '%s, %s, %s, %s, %s, %s, %s, %s, %s' % schd_def
...
class Students(models.Model):
    ...
    def __str__(self):
        ...
        """
        userdef = (self.grp_grp_id.fclt_fclt_id.unvr_unvr_id,
                   self.grp_grp_id.fclt_fclt_id,
                   self.grp_grp_id,
                   self.cthd_cthd_id,
                   self.admission_year,
...
class MyUser(models.Model):
    ...
    stdt_stdt_id = models.ForeignKey(Students)
