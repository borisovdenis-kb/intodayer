# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-07-24 14:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('parity', models.IntegerField(null=True, verbose_name=django.db.models.deletion.DO_NOTHING)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='intodayer2_app.PlanLists')),
            ],
            options={
                'managed': True,
                'db_table': 'subjects',
        ...
        migrations.AddField(
            model_name='places',
            name='plan',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='intodayer2_app.PlanLists'),
        ),
        migrations.AddField(
